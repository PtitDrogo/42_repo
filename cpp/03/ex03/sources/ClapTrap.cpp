...
ClapTrap::ClapTrap() : 
    ...
    _hit_points(10),
    _energy_points(10),
    _attack_damage(0) { std::cout << "ClapTrap Default constructor called for " << _name << std::endl; }
ClapTrap::ClapTrap(std::string _name) : 
    _name(_name),
    _hit_points(10), 
    _energy_points(10),
    _attack_damage(0) { std::cout << "ClapTrap Name constructor called for " << _name << std::endl; }
ClapTrap::ClapTrap(ClapTrap& other) : 
    _name(other.get_name()),
    _hit_points(other.get_hp()), 
    _energy_points(other.get_energy()),
    _attack_damage(other.get_attack()) { std::cout << "ClapTrap Copy constructor called for " << _name << std::endl; }
ClapTrap::~ClapTrap() 
{
